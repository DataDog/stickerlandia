...
/**
 * Tests to enforce explicit result type patterns instead of null returns.
 * These tests ensure that services use type-safe error handling with sealed interfaces.
 */
public class ResultTypeTest {
    ...
    /**
     * Result type classes should exist in the result package.
     * This ensures we have proper result type organization.
     */
    @Test
    ...
    /**
     * All result types should be interfaces to enable sealed interface patterns.
     * This supports type-safe error handling patterns.
     */
    @Test
    ...
    /**
     * Success result cases should contain meaningful domain objects.
     * This ensures successful operations return useful data.
     */
    @Test
    ...
    /**
     * Failure result cases should contain error information.
     * This ensures failed operations provide meaningful error context.
     */
    @Test
    public void failure_cases_should_contain_error_info() {
        ArchRule rule =
                classes()
                    ...
                    .should()
                    .haveOnlyFinalFields()
                    .because("Failure cases should be immutable records with error information");
