...
public class TechnologyGovernanceTest {
    ...
    /**
     * All logging should use JBoss Logging, not other logging frameworks. This ensures consistency
     * with Quarkus logging infrastructure.
     */
    @Test
    public void should_only_use_jboss_logging() {
        ...
        ArchRule noJavaUtilLogging =
                noClasses()
                        .should()
                        .dependOnClassesThat()
                        .resideInAPackage("java.util.logging..")
                        .because(
                                "Use JBoss Logging instead of java.util.logging for consistency with Quarkus");

        ArchRule noCommonsLogging =
                noClasses()
                        .should()
                        .dependOnClassesThat()
                        .resideInAPackage("org.apache.commons.logging..")
                        .because(
                                "Use JBoss Logging instead of Commons Logging for consistency with Quarkus");
    ...
    /**
     * Use Panache abstractions instead of raw Hibernate APIs. Panache provides simpler, more
     * maintainable database access patterns.
     */
    @Test
    public void should_use_panache_not_raw_hibernate() {
        ArchRule noHibernateSession =
                noClasses()
                        .should()
                        .dependOnClassesThat()
    ...
    /**
     * Use modern java.time API instead of legacy java.util.Date. java.time provides better
     * immutability, thread-safety, and API design.
     */
    @Test
    ...
    /**
     * Use Jakarta EE APIs (jakarta.*) not legacy Java EE (javax.*). Jakarta EE is the modern
     * standard after the Oracle → Eclipse transition.
     */
    @Test
    public void should_use_jakarta_not_javax() {
        ArchRule noJavaxWsRs =
                noClasses()
                        .should()
                        .dependOnClassesThat()
        ...
        ArchRule noJavaxPersistence =
                noClasses()
                        .should()
                        .dependOnClassesThat()
                        .resideInAPackage("javax.persistence..")
                        .because(
                                "Use jakarta.persistence not javax.persistence (Jakarta EE migration)");

        ArchRule noJavaxInject =
                noClasses()
                        .should()
                        .dependOnClassesThat()
    ...
    /**
     * Use Jackson for JSON processing, not alternative JSON libraries. Jackson is the standard in
     * Quarkus and provides the best integration.
     */
    @Test
    public void should_use_jackson_for_json() {
        ArchRule noGson =
                noClasses()
                        ...
                        .because(
                                "Use Jackson (com.fasterxml.jackson) not Gson for JSON processing");
        ...
        ArchRule noOrgJson =
                noClasses()
                        ...
                        .because(
                                "Use Jackson (com.fasterxml.jackson) not org.json for JSON processing");

        ArchRule noJsonSimple =
                noClasses()
                        .should()
                        .dependOnClassesThat()
                        .resideInAPackage("org.json.simple..")
                        .because(
                                "Use Jackson (com.fasterxml.jackson) not json-simple for JSON processing");
    ...
    /**
     * Use JUnit 5 (Jupiter) not legacy JUnit 4 for testing. JUnit 5 provides better assertions,
     * lifecycle management, and extension model.
     */
    @Test
    public void should_use_junit5_not_junit4() {
        ArchRule noJunit4 =
                noClasses()
                        .should()
                        .dependOnClassesThat()
                        .resideInAPackage("org.junit") // JUnit 4 package (no subpackages)
                        .because("Use JUnit 5 (org.junit.jupiter) not JUnit 4 for testing");

        ArchRule noJunit4Assert =
                noClasses()
                        .should()
                        .dependOnClassesThat()
    ...
    /**
     * Use Quarkus-provided testing utilities instead of generic alternatives. This ensures better
     * integration with Quarkus lifecycle and configuration.
     */
    @Test
    public void should_use_quarkus_testing_utilities() {
        ...
        ArchRule noApacheHttpClient =
                noClasses()
                        ...
                        .because(
                                "Use REST Assured not Apache HttpClient for API testing in Quarkus");
