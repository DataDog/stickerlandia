...
class StickerImageServiceTest {
    ...
    void testUploadImage() {
        ...
        String imageKey = stickerImageService.uploadImage(imageStream, "image/png", testImageData.length);
    ...
    void testDeleteImage() {
        ...
        assertThrows(NoSuchKeyException.class, () -> 
            stickerImageService.getImage(uploadedImageKey));
    }
    ...
    void testGetNonExistentImage() {
        ...
        assertThrows(NoSuchKeyException.class, () -> 
            stickerImageService.getImage(nonExistentKey));
    }
    ...
    void testUploadLargeImage() {
        ...
        String imageKey = stickerImageService.uploadImage(imageStream, "image/png", largeImageData.length);
