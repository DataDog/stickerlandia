    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    PrinterId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    ...
                    LastJobProcessed = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    PrintJobId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    PrinterId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    UserId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    StickerId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutboxItems_ItemId",
                table: "OutboxItems",
                column: "ItemId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OutboxItems_Processed_EventTime",
                table: "OutboxItems",
                columns: new[] { "Processed", "EventTime" });

            migrationBuilder.CreateIndex(
                name: "IX_Printers_EventName",
                table: "Printers",
                column: "EventName");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrintJobs_PrinterId_Status_CreatedAt",
                table: "PrintJobs",
                columns: new[] { "PrinterId", "Status", "CreatedAt" });
