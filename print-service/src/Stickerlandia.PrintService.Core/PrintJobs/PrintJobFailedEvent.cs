...
public record PrintJobFailedEvent : DomainEvent
{
    public PrintJobFailedEvent() { }

    public PrintJobFailedEvent(PrintJob printJob)
    {
    ...
    public override string EventName => "printJobs.failed.v1";
